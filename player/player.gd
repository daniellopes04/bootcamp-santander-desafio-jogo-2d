...
#var attack_direction_number: int = 1
...
func attack() -> void:
	...
	animation_player.play("attack_side_1")
		...
		#attack_direction_number = 4
	#elif input_vector.y < 0:
		#animation_player.play("attack_up_1")
		#attack_direction_number = 3
	#elif input_vector.x > 0:
		#animation_player.play("attack_side_1")
		#attack_direction_number = 2
	#else:
		#animation_player.play("attack_side_1")
		#attack_direction_number = 1
...
func deal_damage_to_enemies() -> void:
	...
	for body in bodies:
		if body.is_in_group("enemies"):
			...
			#if (attack_direction_number == 1):
				#attack_direction = Vector2.LEFT
			#elif (attack_direction_number == 2):
				#attack_direction = Vector2.RIGHT
			#elif (attack_direction_number == 3):
...
func damage(amount: int) -> void:
	...
	health -= amount
	print("Jogador recebeu dano de ", amount, " a vida total e de ", health, "/", max_health)
